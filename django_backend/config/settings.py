...
MIDDLEWARE = [
    'debug_toolbar.middleware.DebugToolbarMiddleware',  # Move this to the top
...
DIALOGFLOW_CREDENTIALS = service_account.Credentials.from_service_account_file(GOOGLE_APPLICATION_CREDENTIALS)
